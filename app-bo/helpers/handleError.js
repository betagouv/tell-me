...
export default function handleError(error, path) {
  ...
  switch (true) {
    ...
    default:
      ...
      ß.error(`[app-bo/helpers/handleError()] This type of error can't be processed. This should never happen.`, '❌')
      ß.error(`[app-bo/helpers/handleError()] Error Type: ${typeof error}`, '❌')
      ß.error(`[app-bo/helpers/handleError()] Error Constructor: ${getErrorConstructorName(error)}`, '❌')
